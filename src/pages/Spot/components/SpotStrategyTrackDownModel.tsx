    ...
    >
      <ProFormText name="id" hidden={true} initialValue={current.id} />
        ...
        <ProFormSelect
          ...
          initialValue={current.trackDown}
        />

        <ProFormText
          name="trackDownInterval"
          label=""
          width={600}
          rules={[
            {
          ...
          initialValue={current.trackDownInterval}
        />

        <ProFormDigit
          name="trackDownPercent"
          label="跌幅触发(负数)"
          width={200}
          rules={[
            {
          ...
          initialValue={current.trackDownPercent}
        />

        <ProFormDigit
          name="trackDownMaxNumber"
          label="底价追踪补仓最大次数"
          tooltip="数值范围1~10"
          width={140}
          rules={[
          ...
          initialValue={current.trackDownMaxNumber}
        />

        <ProFormDigit
          name="trackDownMaxHoldPercent"
          label="最大持仓限制"
          width={140}
          rules={[
            {
          ...
          fieldProps={{ addonAfter: '%' }}
          initialValue={current.trackDownMaxHoldPercent}
        />
